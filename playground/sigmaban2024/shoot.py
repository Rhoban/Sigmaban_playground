...
# ==============================================================================
"""Shoot task for Sigmaban. (based on Berkeley Humanoid)"""
...
from playground.common.episodic_reference_motion_splines import EpisodicReferenceMotion
...
class Shoot(sigmaban_base.SigmabanEnv):
    """Shoot task."""
    ...
    def reset(self, rng: jax.Array) -> mjx_env.State:
        ...
        root_qpos = jp.concatenate([jp.array([0.0, 0.0, 0.4]), jp.array([1.0, 0.0, 0.0, 0.0])])
    ...
    def step(self, state: mjx_env.State, action: jax.Array) -> mjx_env.State:
        if USE_IMITATION_REWARD:
            ...
            state.info["current_reference_motion"] = self.PRM.get_frame(
                state.info["imitation_i"],
            )
        else:
    ...
    def _get_termination(self, data: mjx.Data, info: dict[str, Any]) -> jax.Array:
        ...
        episode_end_termination = info["imitation_i"] >= self.PRM.nb_steps - 1
        return (
            episode_end_termination
            | fall_termination
